...
public class TrainingSessionController {
  ...
  @PostMapping
  public ResponseEntity<TrainingSession> bookTrainingSession(@RequestBody TrainingSession trainingSession) {
    TrainingSession createdSession = trainingSessionService.createTrainingSession(trainingSession);
